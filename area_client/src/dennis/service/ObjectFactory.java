 ...
 * generated in the dennis.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryArea_QNAME = new QName("http://Service.dennis/", "queryArea");
    private final static QName _QueryAreaResponse_QNAME = new QName("http://Service.dennis/", "queryAreaResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: dennis.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.dennis/", name = "queryArea")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.dennis/", name = "queryAreaResponse")
