 ...
 * 
 */
@WebServiceClient(name = "AreaServiceInterfaceImplService", targetNamespace = "http://Service.dennis/", wsdlLocation = "http://127.0.0.1:12345/area?wsdl")
    ...
    extends Service
{
    ...
    private final static QName AREASERVICEINTERFACEIMPLSERVICE_QNAME = new QName("http://Service.dennis/", "AreaServiceInterfaceImplService");
    ...
    public AreaServiceInterfaceImpl getAreaServiceInterfaceImplPort() {
        return super.getPort(new QName("http://Service.dennis/", "AreaServiceInterfaceImplPort"), AreaServiceInterfaceImpl.class);
    }
    ...
    public AreaServiceInterfaceImpl getAreaServiceInterfaceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Service.dennis/", "AreaServiceInterfaceImplPort"), AreaServiceInterfaceImpl.class, features);
    }
